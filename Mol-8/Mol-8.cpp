...
result = system->createSound("01. Встречная полоса.mp3", FMOD_3D, 0, &sound); // creating sound
...
//	FMOD_VECTOR velocity = { 0.0f,  i / 100.0f, 0.0f };
	FMOD_VECTOR velocity= {0.0f, 0.0f, i/100.0f};
//	FMOD_VECTOR listenerpos = {0.f, 0.0f, 0.0f };
	FMOD_VECTOR listenerpos = {0.2f*i/1000, 0.0f, 0.0f };
